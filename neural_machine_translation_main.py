...
if __name__=='__main__':
    ...
    parser.add_argument('--num_encoder_layer', default=6, type=int, help='number of encoder layer')
    parser.add_argument('--num_decoder_layer', default=6, type=int, help='number of decoder layer')
    parser.add_argument('--num_common_layer', default=6, type=int, help='number of common layer for PTransformer')
    ...
    parser.add_argument('--n_warmup_epochs', type=int, default=3, help='Learning rate warmup epoch; Default is 3')
